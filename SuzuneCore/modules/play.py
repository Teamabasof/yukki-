...
from SuzuneCore.base.decorators import errors, sudo_users_only
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
   ...
   # img_arr =np.array(image3)
    ...
    # fonts
    font1 = ImageFont.truetype(r'resources/SuzuneCore.otf', 30)
    font2 = ImageFont.truetype(r'resources/SuzuneCore.otf', 60)
    font3 = ImageFont.truetype(r'resources/SuzuneCore.otf', 49)
...
async def play(_, message: Message):
    ...
    [
       ...
       [
            InlineKeyboardButton("Watch", url="https://youtube.com"),
